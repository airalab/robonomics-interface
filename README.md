...
Another dedicated function will return **Account information**:
```python
account_info = interface.account_info(<ss58_addr>)
```
This will give you the latest account information of the specified account. If you create an interface with a provided seed, you'll be able to get self-account 
